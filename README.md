...
This project uses Firebase Auth (Email/Password) and Firestore. To run locally with your own Firebase project:

1. Create a project at [console.firebase.google.com](https://console.firebase.google.com)
2. Enable **Authentication → Email/Password**
3. Create a **Firestore** database in test mode
4. Replace the config in `src/firebase.ts` with your project's credentials
